...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','yy.tivinci.js')
	...
	f = os.path.join(cwd,'Classes','YyTivinciModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','yy.tivinci.js']
